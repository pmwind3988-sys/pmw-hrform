      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Sign in with your Microsoft 365 account to view your submission history and approval status.
            </Typography>
            ...
            <Stack spacing={2.5} sx={{ width: "100%" }}>
              ...
              <FormControlLabel
                ...
                label={
                  <Typography
                    variant="body2"
                    sx={{ color: "rgba(0,0,0,0.55)", fontSize: "0.85rem" }}
                  >
            ...
            >
              Only PMW internal M365 accounts are permitted. Guests can browse but cannot view submissions.
            </Typography>
          </CardContent>
        </Card>
      </Container>
