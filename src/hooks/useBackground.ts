...
export const PREDEFINED_BACKGROUNDS: BackgroundDef[] = [
  {
    id: "clean",
    label: "Clean Light",
    css: "var(--app-bg-fallback, #F6F8FB)",
    preview: "#F6F8FB",
  },
  {
    id: "gradient-soft",
    label: "Quiet Blue",
    css: "linear-gradient(180deg, #F6F8FB 0%, #EEF5FB 52%, #F7F9FC 100%)",
    preview: "linear-gradient(180deg, #F6F8FB 0%, #EEF5FB 52%, #F7F9FC 100%)",
  },
  {
    id: "gradient-warm",
    label: "Warm Neutral",
    css: "linear-gradient(180deg, #FBF8F3 0%, #F6F8FB 48%, #EDF6F3 100%)",
    preview: "linear-gradient(180deg, #FBF8F3 0%, #F6F8FB 48%, #EDF6F3 100%)",
  },
  {
    id: "abstract-waves",
    label: "Abstract Waves",
    css: 'linear-gradient(145deg, rgba(246,248,251,0.94) 0%, rgba(246,248,251,0.94) 100%), url("data:image/svg+xml,%3Csvg viewBox=\'0 0 1200 800\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cdefs%3E%3ClinearGradient id=\'a\' x1=\'0%25\' y1=\'0%25\' x2=\'100%25\' y2=\'100%25\'%3E%3Cstop offset=\'0%25\' stop-color=\'%236264A7\' stop-opacity=\'0.08\'/%3E%3Cstop offset=\'100%25\' stop-color=\'%230078D4\' stop-opacity=\'0.04\'/%3E%3C/linearGradient%3E%3C/defs%3E%3Cpath d=\'M0 400 Q150 300 300 400 T600 400 T900 400 T1200 400 L1200 800 L0 800 Z\' fill=\'url(%23a)\'/%3E%3Cpath d=\'M0 500 Q200 380 400 500 T800 500 T1200 500 L1200 800 L0 800 Z\' fill=\'url(%23a)\' opacity=\'0.6\'/%3E%3C/svg%3E") center/cover no-repeat',
    preview: "#F8F9FC",
  },
  {
    id: "geometric",
  ...
  },
  {
    id: "floating-circles",
    label: "Soft Grid",
    css: "linear-gradient(180deg, rgba(246,248,251,0.96) 0%, rgba(246,248,251,0.96) 100%), repeating-linear-gradient(0deg, transparent 0, transparent 23px, rgba(0,120,212,0.05) 24px), repeating-linear-gradient(90deg, transparent 0, transparent 23px, rgba(17,24,39,0.04) 24px)",
    preview: "linear-gradient(180deg, #F6F8FB 0%, #EEF5FB 100%)",
  },
  {
    id: "diagonal-flow",
    label: "Diagonal Flow",
    css: 'linear-gradient(145deg, rgba(246,248,251,0.94) 0%, rgba(246,248,251,0.94) 100%), url("data:image/svg+xml,%3Csvg viewBox=\'0 0 1200 800\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cdefs%3E%3ClinearGradient id=\'s\' x1=\'0%25\' y1=\'0%25\' x2=\'100%25\' y2=\'100%25\'%3E%3Cstop offset=\'0%25\' stop-color=\'%236264A7\' stop-opacity=\'0.06\'/%3E%3Cstop offset=\'100%25\' stop-color=\'%230078D4\' stop-opacity=\'0.02\'/%3E%3C/linearGradient%3E%3C/defs%3E%3Cpath d=\'M-100 100 L1100 700\' stroke=\'url(%23s)\' stroke-width=\'40\' fill=\'none\'/%3E%3Cpath d=\'M-100 250 L1100 850\' stroke=\'url(%23s)\' stroke-width=\'30\' fill=\'none\' opacity=\'0.6\'/%3E%3Cpath d=\'M-100 -50 L1100 550\' stroke=\'url(%23s)\' stroke-width=\'50\' fill=\'none\' opacity=\'0.4\'/%3E%3C/svg%3E") center/cover no-repeat',
    preview: "#F8F9FC",
  },
  {
    id: "particles",
    label: "Blueprint Grid",
    css: "linear-gradient(180deg, rgba(247,249,252,0.97) 0%, rgba(247,249,252,0.97) 100%), repeating-linear-gradient(0deg, transparent 0, transparent 31px, rgba(98,100,167,0.04) 32px), repeating-linear-gradient(90deg, transparent 0, transparent 31px, rgba(0,120,212,0.04) 32px)",
    preview: "linear-gradient(135deg, #F7F9FC 0%, #EEF3F8 100%)",
  },
